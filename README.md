...
21. Receba 3 coeficientes A, B, e C de uma equação do 2o grau da fórmula AX2+BX+C=0. Verifique
e mostre a existência de raízes reais e se caso exista, calcule e mostre.

22. Receba 4 notas bimestrais de um aluno. Calcule e mostre a média aritmética. Mostre a
...
24. Receba 3 valores obrigatoriamente em ordem crescente e um 4o valor não necessariamente
em ordem. Mostre os 4 números em ordem crescente.

25. Receba um valor inteiro. Verifique e mostre se é divisível por 2 e 3.

26. Receba a hora de início e de final de um jogo (HH,MM), calcular o tempo do jogo em horas e
...
28. Receba o número de voltas, a extensão do circuito (em metros) e o tempo de duração
(minutos). Calcule e mostre a velocidade média em km/h.

29. Receba o preço atual e a média mensal de um produto. Calcule e mostre o novo preço
sabendo que:
